...
from app.models import ADR, DiagramOutput, ReconciledModel


# ---------------------------------------------------------------------------
# Unified ADR Template Registry
# ---------------------------------------------------------------------------
...
def generate_adrs(
    ...
    # Build (category, source_values) pairs from the analysis model
